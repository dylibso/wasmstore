...
let wasm_verify_file =
  fn "wasm_verify_file" (string @-> size_t @-> returning (ptr char))

let wasm_verify_string =
  fn "wasm_verify_string" (string @-> size_t @-> returning (ptr char))
